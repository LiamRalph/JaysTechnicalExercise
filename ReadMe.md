...
Disclaimer: I know using correlation isn't the best when looking at multi-inputs compared to outputs (Variables could be confounding or have non-linear relationships), but using Feature Importance based off Gain shows similar levels of effect.
